...
2. Gordon Conference abstract
3. KC deliverables
4. EFM presentation
5. Continue on volume-from-casts method.

### Completed Goals:
1. Created "subthreshold thickness" plots.
2. Gordon Conference abstract - submitted 2/21/2022.
3. KC deliverables - presented 2/24/2023.
4. EFM presentation - presented 2/23/2023.
5. Continue on volume-from-casts method.
...
<p style="text-align:center;"><img src="https://user-images.githubusercontent.com/55995675/221961601-6585cfdf-c1a1-4066-ac9d-4d8baf03418c.png" width="900"/><br>Fig 2. Total subthreshold volume for the first of each month during 2022; orange is LO output and blue is estimate from volume-from-casts method.</p><br>

Figure 3 and 4 shows previous and updated one-year plans, as presented in the KC meeting.

<p style="text-align:center;"><img src="https://user-images.githubusercontent.com/55995675/221962584-3f153745-05b7-407d-996a-b511c46ebcdd.png" width="1200"/><br>Fig 3. Outdated cademic year overview, scoped Fall 2022.</p><br>

<p style="text-align:center;"><img src="https://user-images.githubusercontent.com/55995675/221962628-ea8603ab-3cf2-4f9c-a772-8631523290fc.png" width="1200"/><br>Fig 4. New academic year overview, updated Winter 2023.</p><br>
...
In general, however, there is not evidence of "DO inversions" within these transects which was hyppthesized to account for some error (Figure 2). More transects and three-dimensional studies are needed.

Rough next steps for volume-from-casts method:
1. Understand the "constant offset" seen in preliminary study (Figure 2).
2. Try throughout the domain.
3. Realistic time domains.
4. Quantify errors - *what does this entail? Bias/RMSE?*
6. Figure out how many transects in time/space required to converge on solution, compare to actual.

---

## Bookkeeping 
* Gordon Conference - ACCEPTED, plan to register today given greenlight
  * I have a conflict with Sunday/Monday of conference dates; intend to book flight for Monday, 6/19/2023.
...
### Looking Ahead:
1. Start error-estimations for volume-from-casts method.
