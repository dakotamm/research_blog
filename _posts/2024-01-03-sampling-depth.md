# Resetting After Holidays and Sampling Depth Over Time Update

### Goals From Last Meeting:
1. Continue to scope future work (ongoing).
2. Update confidence intervals to use degrees-of-freedom in lieu of number of data points.
3. Investigate Saanich Inlet breakout.
4. Investigate sampling depth change over time for DO.
   
### Completed Goals:
1. Investigated sampling depth change over time for DO.
2. Holidays!!!

---

## Sampling Depth Over Time Updates
...
* Seasonal averages (with nice contrasting colors!) + annual averages for CT/SA/DO.
* I have Skagit discharge data since 1940...explore the correlation between monthly discharge and CT/SA/DO?
* Consider control for sampling depth and correlation to observed trends.

Other thoughts from before break:
